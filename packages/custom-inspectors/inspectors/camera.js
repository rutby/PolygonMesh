...
Vue.component("cc-camera", {
  ...
  methods: {
    ...
    _cullingMaskChanged(e, t) {
      ...
      (this.target.cullingMask.value = r), this._setProperty(r, "cullingMask");
    },
    _everythingMask() {
    ...
    _everythingMaskChanged(e) {
      ...
      e.currentTarget.value &&
        (t = 4294967295), (this.target.cullingMask.value = t), this._setProperty(
        t,
        "cullingMask"
      );
    },
    ...
    clearFlagsChanged(e, t) {
      ...
      for (let i = 0, a = this.clearFlags.length; i < a; i++)
        r += i !== t ? n & (1 << i) : e.currentTarget.value ? 1 << t : 0;
      (this.target.clearFlags.value = r), this._setProperty(r, "clearFlags");
    },
    _renderStages(e) {
    ...
    renderStagesChanged(e, t) {
      ...
      for (let i = 0, a = this.renderStages.length; i < a; i++)
        r += i !== t ? n & (1 << i) : e.currentTarget.value ? 1 << t : 0;
      (this.target.renderStages.value = r), this._setProperty(
        r,
        "renderStages"
      );
    }
  ...
  compiled() {
    ...
    (this.profile = e), (this.groupList = e.get("group-list")), e.on(
      "changed",
